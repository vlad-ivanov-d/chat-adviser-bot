...
import { TELEGRAM_BOT_API_BASE_URL } from "test/constants";
...
export const server = setupServer(
  ...
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/getChat`, getChatResolver),
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/getChatAdministrators`, getChatAdministratorsResolver),
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/getChatMember`, getChatMemberResolver),
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/getChatMembersCount`, getChatMembersCountResolver),
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/getMe`, () => HttpResponse.json({ ok: true, result: bot })),
  http.post(`${TELEGRAM_BOT_API_BASE_URL}/setWebhook`, () =>
